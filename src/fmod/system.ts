...
export const FMOD: any = {
    ...
    async onRuntimeInitialized() {
        ...
        FMOD.Result = FMOD.Core.getDriverInfo(
            0,
            null,
            null,
            sampleRate,
        ...
        FMOD.Result = FMOD.Core.setSoftwareFormat(
            sampleRate.deref(),
        ...
        FMOD.Result = FMOD.Studio.initialize(
            32,
    ...
    set Result(code: number) {
        ...
        throw new Error(
            `FMOD failed with code ${code}: ${FMOD.ErrorString(code)}`,
        );
    },
    Studio: {} as any,
    Core: {} as any,
