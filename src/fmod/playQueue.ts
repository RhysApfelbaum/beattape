...
export class PlayQueue {
    ...
    trackDistance(track: Track): number {
        ...
        result += Math.abs(
            this.sliderState.grit - track.averageSliderState.grit,
        );
        result += Math.abs(
            this.sliderState.brightness - track.averageSliderState.brightness,
        );
        result += Math.abs(
            this.sliderState.chops - track.averageSliderState.chops,
        );
        result += Math.abs(
            this.sliderState.vocals - track.averageSliderState.vocals,
        );
        result /= 4;
